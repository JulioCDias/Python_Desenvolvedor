...
def criar_slide(titulo, texto, imagem, cor_fundo, cor_texto):
    ...
    # Converte a imagem para base64 se etsiver presente
    imagem_html = ""
...
iface = gr.Interface(
    fn=criar_slide,
    inputs=[
        gr.Textbox(label="Título", placeholder="Digite o título do slide"),
        gr.Textbox(label="Texto", placeholder="Digite o texto do slide"),
    ...
    description="Crie um slide com título, texto e imagem",
)
iface.launch()
